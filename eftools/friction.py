...
from eftools.utils import grep, kernel_transform
from eftools.elsi import ELSIReader
from eftools.units import atomic
import numpy as np
import re
import pandas as pd
import numpy as np
...
def main():
    ...
    group.add_argument("--broadening", type=float, default=0.01, 
                       ...
                       "Analogous to `friction_broadening_width` in FHI-aims.")
